...
class TestVLMModelWholeFirst(TestVLMModel):
    def test_vlm_model_whole(self):
        ...
        F_oas = np.array([-187.34473671, 0.,
                          3450.19126818]).reshape(num_nodes, 3)
        M_oas = np.array([2.27373675e-13, 1.79258124e+03,
                          7.10542736e-15]).reshape(num_nodes, 3)
        self.assertIsNone(
