...
eval_pts_shapes = [mesh_val.shape]
eval_pts_names = [x + '_eval_pts_coords' for x in surface_names]

eval_pts_coords = deepcopy(mesh_val)
eval_pts_coords[:, :, :, 2] -= 0.5  # displace in z-direction the evaluation points relative to the surface mesh
