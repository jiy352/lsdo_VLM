...
class ODESystemModel(csdl.Model):
    ...
    def define(self):
        ...
        # bd_vortex_names = self.parameters['bd_vortex_names']
        ...
        for i in range(len(surface_shapes)):
            ...
            surface_shapes = [(nt, nx, ny, 3)]

            self.create_input('wing_1', shape=(n,nx, ny, 3))
        ...
        self.add(SolveMatrix(nt=nt,
                                bd_vortex_shapes=surface_shapes), name='solve_gamma_b_group')
