...
class ODEProblemTest(ODEProblem):
    def setup(self):
        ...
        self.add_profile_output('gamma_w_all',
                                state_name='gamma_w',
                                shape=(nt - 1, ny - 1))
        self.add_profile_output('delta_p',
                                state_name='gamma_w',
                                shape=((nx - 1) * (ny - 1), ))
        self.add_profile_output('v_induced_bd',
                                state_name='gamma_w',
                                shape=((nx - 1) * (ny - 1), 3))
        self.add_profile_output('v_induced_w',
                                state_name='gamma_w',
                                shape=((nx - 1) * (ny - 1), 3))
        ...
        self.add_state(
            'gamma_w',
            'dgammaw_dt',
            initial_condition_name='gamam_w_0',
            shape=(nt - 1, ny - 1),
        )
